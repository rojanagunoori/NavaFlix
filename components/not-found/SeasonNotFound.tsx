  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center">
      <div className="glass-container text-center max-w-lg">
        ...
        <div className="mt-6">
         <Link href={`/series/${seriesId}/season/${seasonId}`} passHref>
  <a className="bg-primary hover:bg-primary/90 text-black font-semibold px-4 py-2 rounded smooth-transition inline-block">
    Back to Season
  </a>
</Link>
