...
async function fetchSomething() {
  const { ACCESS_TOKEN, API_KEY } = checkAccessToken();
  console.log("TMDB ACCESS_TOKEN inside function:", ACCESS_TOKEN);
  console.log("TMDB API_KEY inside function:", API_KEY);
}

// fetchSomething()
const getHeaders = () => {
  const { ACCESS_TOKEN } = checkAccessToken(); // read env here
